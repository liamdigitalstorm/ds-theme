...
function mb_register_required_plugins() {
	$plugins = array(
        ...
        array(
			'name'               => 'Toolset Views', // The plugin name.
            'slug'               => 'views', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/lib/plugins/views.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(
        ...
        array(
			'name'               => 'WP Page Bakery', // The plugin name.
            'slug'               => 'jscomposer', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/lib/plugins/jscomposer.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ),
        array(
			'name'               => 'WPMU Dashboard', // The plugin name.
            'slug'               => 'wpmu', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/lib/plugins/wpmu.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		),
	);
    /*
