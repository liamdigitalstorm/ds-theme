		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					'This theme requires the following plugin: %1$s. Do note, this plugin may need updating after installation.',
					'This theme requires the following plugins: %1$s. Do note, these plugins may need updating after installation.',
					'tgmpa'
				),
